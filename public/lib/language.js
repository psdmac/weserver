...
OpenLayers.Lang["zh-CN"] = {
    ...
    // console message
    'filterEvaluateNotImplemented': "不支持的滤镜类型",

    'proxyNeeded': "您必须设置OpenLayers.ProxyHost才能访问${url}。"+
        "请参考http://trac.osgeo.org/openlayers/wiki/FrequentlyAskedQuestions#ProxyHost。",
    
    // OpenLayers.Layer.OSM
    'OSM_Mapnik': '开源地图',
    'OSM_Cycle': '开源地形图',
    'OSM_Transport': '开源交通地图',
    'OSM_MapQuest': 'MapQuest开放地图',
